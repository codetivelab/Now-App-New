...
public class VideoPreviewActivity extends AppCompatActivity implements Player.EventListener {
    ...
    public static void getStartIntent(Activity context, String videoUri) {
