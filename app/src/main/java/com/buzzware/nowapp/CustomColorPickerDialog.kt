 ...
 * @since 23 Dec 2019
 */
class CustomColorPickerDialog private constructor(
    val context: Context,
    val title: String,
    ...
    class Builder(val context: Context) {
         ...
         */
        fun build(): CustomColorPickerDialog {
    ...
    fun show() {
        ...
        val recentTV = dialogView.findViewById<TextView>(R.id.recentColorTitleTxt)
        ...
        recentColorsRV.visibility = View.GONE
